...
// */
internal fun Activity.showBluetootheError(exception: BleScanException) =
    getBleErrorMessage(exception).let { errorMessage ->
        Log.e("Scanning", errorMessage, exception)
        showSnackbarShort(errorMessage)
    }

private fun Activity.getBleErrorMessage(exception: BleScanException): String =
